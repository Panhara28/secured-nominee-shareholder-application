// ISO 3166-1 country list (alpha-2 code + common English name), used by the
// searchable Nationality field in the beneficiary request wizard (item 28).
...
export const COUNTRIES: Country[] = [
  ...
  { code: "ZM", name: "Zambia" }, { code: "ZW", name: "Zimbabwe" }, { code: "OTHER", name: "Other" },
];
